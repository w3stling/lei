...
class LeiLookupByLeiCodeTest {
    ...
    void testLookup() {
        ...
        assertEquals("2025-04-14T15:07:38Z", lei.get().getRegistration().getLastUpdateDate());
        assertEquals(ZonedDateTime.parse("2025-04-14T15:07:38Z"), lei.get().getRegistration().getLastUpdateDateZonedDateTime());
        assertEquals("5299000J2N45DDNE4Y28", lei.get().getRegistration().getManagingLOU());
        assertEquals("2026-06-02T06:47:59Z", lei.get().getRegistration().getNextRenewalDate());
        assertEquals(ZonedDateTime.parse("2026-06-02T06:47:59Z"), lei.get().getRegistration().getNextRenewalDateZonedDateTime());
